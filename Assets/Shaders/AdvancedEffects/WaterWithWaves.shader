Shader "Holistic/WaterWithWaves"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vert (inout appdata v, out Input o) {
			...
			float waveHeight = sin(t + v.vertex.z * _Freq) * _Amp + sin(t * 2 + v.vertex.z * _Freq * 2) * _Amp; //don't need necessarily to add the functions together
